...
void ui_event_scrSplash(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrMain, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnMainRCSW(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrRCSWMain, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnMainPreset(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrPresets, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
        fcnPresetPopDir(e);
    }
}
void ui_event_btnMainPresetTX(lv_event_t * e)
...
void ui_event_btnMainSettings(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrSettings, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnMainWifi(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrWifiApps, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnMainProtAna(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrProtAna, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnProtAnaCncl(lv_event_t * e)
{
...
void ui_event_btnWifiScanner1(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_scrRCSWTenPole, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0);
    }
}
void ui_event_btnBackToRCSW(lv_event_t * e)
{
